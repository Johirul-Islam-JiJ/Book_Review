            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Upazila List
                        <a class="btn btn-success btn-sm " href="{{ route('thanas.index') }}">Back</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('thanas.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-3" id="name" name="name"
                                    value="{{ old('name') }}" placeholder="Enter Upazila Name">
                            </div>
