...
>>>>>>> 5ae5431d56842f46d8ca03596d60e83cfba5ca60
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" id="writer" name="writer" value="{{ old('writer') }}"
                                placeholder="Enter Writer Name">
                        </div>

                        <div class="form-group">
                            <label for="publication">Publication</label>
                            <input type="text" class="form-control mb-3" id="publication" name="publication" value="{{ old('publication') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control mb-3" id="published" name="published" value="{{ old('published') }}"
